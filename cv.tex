...
as a side project, I simulated spatial patterns of oscillating chemical reactions using \CC.

During my work on elastic shells,
I was impressed by the effectiveness of harmonic analysis (a field in pure mathematics) for
...
I collaborated with them in a problem suggested by ITP Areo, a very important company in Spain.
...
Today, I feel motivated and eager to pursue further research.


\section*{Research achievements}

As I mentioned above,
my career is roughly divided in my time as a pure mathematician (before mid-2022), and as an applied mathematician (from mid-2022 to present).
Although my work in pure mathematics gave me solid theoretical experience,
...
we gave a method to solve scalar Ordinary Differential Equations (ODEs)
...
I helped them to provide a rigorous proof so that
...
The data and the code were made publicly available.
...
I received the Juan de la Cierva Scholarship 2019,
a prestigious grant in Spain that
secured me a two-year contract in BCAM.


\section*{Other relevant information and contributions to the research community}

My position at CFAA is to transfer knowledge.
Currently, I participate as a BCAM's team member in a large academic-industry project titled 
\emph{Federated process management architecture in discrete event
manufacturing systems} (SARA).
The industrial consortium is led by Fagor Automation, and
the academic consortium by the EHU through the CFAA.
My tasks include monitoring and modelling of manufacturing processes.

I participated in a \emph{European Study Group with Industry} (ESGI 188), Bilbao, Spain (26-30 May 2025).
I was in charge of organizing Danobat Group's challenge
...
soon I will start supervising Andoni Uyarra, a Master student in mathematics from the EHU.
