...
\begin{itemize}[wide, labelindent=0pt]
    ...
    (2025). Semi-analytical Estimation for the Escape of Solutions of Linear Differential Equations with Slowly Varying Coefficients.
...
\begin{itemize}[wide, labelindent=0pt]
    ...
    (2026).
    The Tustin Method for approximating eigenvalues of delay systems. \textit{J. Comput. Appl. Math.},
    472, 116772.
