...
the possibility of obtaining further grants and funding for my research or scientific events.
Since this project may yield algorithms with industrial relevance,
in the future I could serve as a consultant for development of software with industrial interest.

In the short term,
this project will allow me to learn and apply several techniques in high demand
inside and outside academia.
For example, I have only learnt about NNs in theory, but
I lack practical experience, so
this project will serve as a hands-on training on NNs.
Also, I may need FEM simulations, which
I have only used once in my career many years ago, so
this engineering project will enhance my skills with a more applied component.

Bayesian statistics is conceptually and computationally more demanding than the standard Frequentist statistics,
so researching in this area will make me stand out among my scientific peers, and
it will give me an advantage in the rigorous analysis of experimental data with robust uncertainty quantification.
It is worth noting that I will also gain more experience in data management and analysis.
For example, I still have more to learn about FAIR principles and data versioning.
In previous projects I have used ad hoc methods for data management, but
now I know more techniques which I want to apply.

I plan to develope an open-source Python package ---
...
other researchers can exploit them.
Software maintenance demands several skills to enable an effective interaction with the users, like
...
At CFAA, where I have my office, the researchers approach problems from an industrial perspective, so
the mathematical foundations behind many problems is not their priority.
On the other hand, the Group of Machine Tool Vibrations, led by Z. Dombóvári,
is known for their sensitivity when it comes to appreciate the mathematics behind manufacturing processes,
which will enrich my knowledge with another perspective.

As I have stressed,
Bayesian inference is less common due primarily to computational barriers, but
this project will TODO.
...
In the same way Modal Analysis is an essential tool today in the manufacturing industry,
...
\begin{WPs}[
    ...
    MS.~1: First release version of the project's Python package; and
    MS.~2: Define the title of the project's workshop, dates, and confirmed speakers.
