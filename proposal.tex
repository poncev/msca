...
For instance, a method called Normalizing Flow was used to convert samples to an analytic prior \(p(M)\) in a problem of reconstruction of images from partial or corrupted data \cite{cai24}.
